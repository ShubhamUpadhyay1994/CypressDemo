...
it('test 4', function(){
  ...
  it('test 10', function(){
    firstPagePO.enterSearchText().type('Mocha');
      firstPagePO.googleImapge().type('{enter}');
      firstPagePO.verifySearchResult().contains('About');
  })
  ...
  it('test 11', function(){
    firstPagePO.enterSearchText().type('Chai');
      firstPagePO.googleImapge().type('{enter}');
      firstPagePO.verifySearchResult().contains('About');
  })
  ...
  it('test 12', function(){
    firstPagePO.enterSearchText().type('PM of India');
      firstPagePO.googleImapge().type('{enter}');
      firstPagePO.verifySearchResult().contains('About');
  })

  it('test 13', function(){
    firstPagePO.enterSearchText().type('TATA');
      firstPagePO.googleImapge().type('{enter}');
      firstPagePO.verifySearchResult().contains('About');
  })
  ...
  it('test 14', function(){
    firstPagePO.enterSearchText().type('Airtel');
      firstPagePO.googleImapge().type('{enter}');
      firstPagePO.verifySearchResult().contains('About');
  })
